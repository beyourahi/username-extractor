---
name: username-extractor-reference
description: Detailed worker architecture, auth, Notion, Cloudflare inference, persistence, environment, testing, and gotchas. Read before changing those areas.
---
