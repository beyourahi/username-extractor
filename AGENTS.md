...
- **Never create branches.** Workspace-wide rule from `~/Desktop/projects/AGENTS.md`: parallel work uses `git worktree add ../username-extractor-<feature>` and commits land on `main`.
