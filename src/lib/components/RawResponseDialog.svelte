        ...
        >
            <div class="border-border flex items-center justify-between border-b px-4 py-2">
                ...
                <div class="flex items-center gap-1">
                    <button
                        type="button"
                        class="border-border hover:bg-surface-elevated rounded-sm border px-2 py-0.5 text-[10px] tracking-widest uppercase"
                        onclick={copy}
                        disabled={!raw}
                    >
                    ...
                    <Dialog.Close
                        class="border-border hover:bg-surface-elevated rounded-sm border px-2 py-0.5"
                        aria-label="close"
                    >
                        <X class="h-3 w-3" />
                    </Dialog.Close>
